                        ...
                        <ul class="metismenu" id="menu1">
                            <li class="active">
                                ...
                                <ul class="submenu-angle" aria-expanded="true">
                                    ...
                                    <li><a title="Product Cart" href="date_wise_rate.php"><i class="fa fa-level-down sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Date Wise Rate</span></a></li>
                                            ...
                                            <div class="header-right-info">
                                                <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                    ...
                                                    <li class="nav-item">
                                                            ...
                                                            <li><a href="register.html"><span class="fa fa-lock author-log-ic"></span>Log Out</a>
                                                            </li>
                                    ...
                                    <div class="row" style="margin-left: 190px;">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod" style="font-size: 25px;"><strong> Item List </strong></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
		...
		<table class="table table-bordered">
			...
			<tbody>
				<?php
					...
					$query = mysqli_query($conn, "SELECT * FROM `item`") or die(mysqli_error());
