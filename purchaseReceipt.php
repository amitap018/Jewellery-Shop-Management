...
<body>
    ...
    $sql="INSERT INTO purchase_recid(date,amt,supp_id,type,Narrator,Status) VALUES('" . $_POST['date'] . "', '" . $_POST['amt_payed'] . "','" . $_POST['supp_id'] . "', '$type2', '$narrator2','')";	
    $conn->query($sql);

    $sql2= "INSERT INTO voucher(date,amt,acc_id,type,Narrator,Status) VALUES('" . $_POST['date'] . "', '" . $_POST['amt_payed'] . "','" . $_POST['supp_id'] . "', '$type2', '$narrator2','')";
    $conn->query($sql2);
 
    
   // mysqli_close($conn);
    header("location: purchaseReceipt.php");
    }
                                    ...
                                    <div class="row" style="margin-left: 190px;">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod" style="font-size: 25px;"><strong> Purchase Recid </strong></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
    ...
    <div class="myDiv">
        <form method="post" name="sample">
            <table class="myTD">
                ...
                <tr>
                    <td><span>
                            <label for="table">Supplier Name: </label>
                            <br>
                            <select name="supplier_name" id="supplier_name" required>
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    ?>
                                    <option value="<?php if (isset($supplier_name))
                                        echo $supplier_name; ?>"><?php if (isset($supplier_name))
                    ...
                    <td><span>
                            <label for="table">Supplier ID: </label>
                            <br>
                            <input type="text" name="supp_id" id="supp_id" required >
                            <br>
