                ...
                <div class="left-custom-menu-adp-wrap comment-scrollbar">
                    <nav class="sidebar-nav left-sidebar-menu-pro">
                        ...
                        <li>
                          ...
                          <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.3" href="accountInfo.php"><i class="fa fa-user sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Supplier List</span></a></li>
                                <li><a title="Product List" href="customerInfo.php"><i class="fa fa-money sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Customer List</span></a></li>
                                <li><a title="Dashboard v.3" href="accountInfo.php"><i class="fa fa-cube sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Account List</span></a></li>
                                <li><a title="Product List" href="customerInfo.php"><i class="fa fa-female sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Item List</span></a></li>
                                <li><a title="Product Edit" href="supplierInfo.php"><i class="fa fa-bolt sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Datewise Purchase</span></a></li>
                                <li><a title="Product Detail" href="itemInfo.php"><i class="fa fa-heart-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Datewise Sell</span></a></li>
