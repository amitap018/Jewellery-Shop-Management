                                    ...
                                    <div class="row" style="margin-left: 190px;">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod" style="font-size: 25px;"><strong> Date wise Rate </strong></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
          ...
          <th>Action</th>
			...
			<tbody>
				<?php
					...
					$query = mysqli_query($conn, "SELECT * FROM `datewiserate`") or die(mysqli_error());
					while($fetch = mysqli_fetch_array($query)){
				?>
				<tr>
					<td><?php echo $fetch['date']?></td>
					<td><?php echo $fetch['silver_rate']?></td>
					<td><?php echo $fetch['gold_rate']?></td>
				...
				<?php
					...
					include 'update_datewiserate.php';
	...
	<div class="modal fade" id="form_modal" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form method="POST" action="save_datewiserate.php">
              ...
              <div class="form-group">
								...
								<input type="number" name="silver_rate" class="form-control" required="required"/>
							</div>

              <div class="form-group">
								<label>Gold Rate</label>
								<input type="number" name="gold_rate" class="form-control" required="required"/>
							</div>
