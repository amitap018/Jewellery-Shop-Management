...
<body>
    ...
    if (isset($_POST['submitData'])) {
        ...
        $supplier_name = $_COOKIE['supplier_name'];
        $query = "SELECT user_id from supplieruser where name='$supplier_name'";
        ...
        $sql = "INSERT INTO master_info(supplier_id,amount, total_gst, payable_amount, payed_cash,payed_qr,payed_ch,amount_payed,balance) VALUES('$supp_id','" . $_POST['amount2'] . "', '" . $_POST['total_gst'] . "', '" . $_POST['payable_amount'] . "', '" . $_POST['payed_cash'] . "', '" . $_POST['payed_qr'] . "', '" . $_POST['payed_ch'] . "', '" . $_POST['amount_payed'] . "', '" . $_POST['balance'] . "')";
                //"INSERT INTO purchase_recid(date,amt,supp_id,type,Narrator,Status) VALUES('" . $_POST['date'] . "', '" . $_POST['payable_amount'] . "','$supp_id', '$type', '$narrator','')";	
        $conn->query($sql);

        $sql3="INSERT INTO purchase_recid(date,amt,supp_id,type,Narrator,Status) VALUES('" . $_POST['date'] . "', '" . $_POST['payable_amount'] . "','$supp_id', '$type1', '$narrator1','')";	
        $conn->query($sql3);

        $sql4="INSERT INTO purchase_recid(date,amt,supp_id,type,Narrator,Status) VALUES('" . $_POST['date'] . "', '" . $_POST['amount_payed'] . "','$supp_id', '$type2', '$narrator2','')";	
        $conn->query($sql4);

        $sql5= "INSERT INTO voucher(date,amt,acc_id,type,Narrator,Status) VALUES('" . $_POST['date'] . "', '" . $_POST['amount_payed'] . "','$supp_id', '$type2', '$narrator2','')";
        $conn->query($sql5);
    
        $sql2 = "SELECT master_id FROM master_info ORDER BY master_id DESC LIMIT 1";
...
<div class="left-sidebar-pro">
                                    ...
                                    <div class="row" style="margin-left: 190px;">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod" style="font-size: 25px;"><strong> Purchase Form </strong></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
    ...
    <div class="myDiv">
        <form method="post" name="sample">
            ...
            <tr>
            <td><span>
                            <label for="table">Suppiler Name: </label>
                            <br>
                            <select name="supplier_name" id="supplier_name" required>
                                <option value="0">Please Select</option>
                                <?php
                                $query = "SELECT name FROM supplieruser";
                                $result = $conn->query($query);
                                while ($row = mysqli_fetch_array($result)) {
                                    $supply_name = $row['name'];

                                    ?>
                                    <option value="<?php if (isset($supply_name))
                                        echo $supply_name; ?>"><?php if (isset($supply_name))
                                              echo $supply_name; ?></option>
                                    <?php
                                }
                                ?>
                            </select>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#supplier_name').on('change', function () {
                supplier_name = this.value;
                document.cookie = "supplierName = " + supplier_name;
            });
