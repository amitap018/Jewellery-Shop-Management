                    ...
                    <nav class="sidebar-nav left-sidebar-menu-pro">
                        <ul class="metismenu" id="menu1">
                            ...
                            <li>
                              ...
                              <ul class="submenu-angle" aria-expanded="true">
                              <li><a title="Dashboard v.3" href="accountInfo.php"><i class="fa fa-square-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Purchase Form</span></a></li>
                              <li><a title="Product List" href="customerInfo.php"><i class="fa fa-male sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Sell Form</span></a></li>
                          ...
                          <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                            <li><a title="Dashboard v.3" href="accountInfo.php"><i class="fa fa-lock sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Purchase Resid</span></a></li>
                            <li><a title="Product List" href="customerInfo.php"><i class="fa fa-unlock sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Sell Resid</span></a></li>
                                    ...
                                    <div class="row" style="margin-left: 190px;">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod" style="font-size: 25px;"><strong> Supplier Info </strong></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
		...
		<table class="table table-bordered">
			...
			<tbody>
				<?php
					...
					$query = mysqli_query($conn, "SELECT * FROM `supplieruser`") or die(mysqli_error());
				...
				<?php
					...
					include 'update_supplieruser.php';
	...
	<div class="modal fade" id="form_modal" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form method="POST" action="save_supplieruser.php">
					...
					<div class="modal-body">
						...
						<div class="col-md-8">
                            ...
                            <div class="form-group">
                                <label>Type</label> 
                                <input type="radio" name="type" value="Retailer" class="form-control" checked required="required"/> 
                                <label>Retailer</label> <br><br>
                                <label>Wholesaler</label> 
                                <input type="radio" name="type" value="Wholesaler" class="form-control" required="required"/>
							</div>
                            <div class="form-group">
								<label>GST</label>
