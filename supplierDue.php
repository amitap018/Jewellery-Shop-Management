                                    ...
                                    <div class="row" style="margin-left: 190px;">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod" style="font-size: 25px;"><strong> Supplier Due </strong></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
		...
		<table class="table table-bordered">
			...
			<tbody>
				<?php
					...
					$query = mysqli_query($conn, "SELECT user_id, name, type FROM `supplieruser`") or die(mysqli_error());
					while($fetch = mysqli_fetch_array($query)){
                        $supplierId = $fetch['user_id'];

                        $sql = "SELECT SUM(balance) AS total_due FROM master_info WHERE supplier_id = $supplierId";
