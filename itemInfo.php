                                    ...
                                    <div class="row" style="margin-left: 190px;">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod" style="font-size: 25px;"><strong> Item Info </strong></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
					...
					<div class="modal-body">
						...
						<div class="col-md-8">
							...
							<div class="form-group">
								...
								<input type="radio" name="category" value="Gold" class="form-control" checked required="required"/> 
							...
							<div class="form-group">
								<label>Weight</label>
								<input type="text" name="weight" class="form-control" required="required"/>
							</div>
							<div class="form-group">
