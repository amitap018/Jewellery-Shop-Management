                                    ...
                                    <div class="row" style="margin-left: 190px;">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod" style="font-size: 25px;"><strong> Account Info </strong></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
		...
		<table class="table table-bordered">
			...
			<tbody>
				<?php
					...
					$query = mysqli_query($conn, "SELECT * FROM `account`") or die(mysqli_error());
					...
					<div class="modal-body">
						...
						<div class="col-md-8">
							<div class="form-group">
								...
								<input type="radio" name="type" value="Income" class="form-control" checked required="required"/> 
