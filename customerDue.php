                                    ...
                                    <div class="row" style="margin-left: 190px;">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod" style="font-size: 25px;"><strong> Customer Due </strong></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
		...
		<table class="table table-bordered">
			...
			<tbody>
				<?php
					...
					$query = mysqli_query($conn, "SELECT user_id, name FROM `customer`") or die(mysqli_error());
					while($fetch = mysqli_fetch_array($query)){
                        $customerId = $fetch['user_id'];

                        $sql = "SELECT SUM(balance) AS total_due FROM sell_master WHERE cust_id = $customerId";
